...
const paths = {
  ...
  styles: {
    src: ["src/assets/styles/*.css", "src/assets/styles/sass/*.scss"],
    dest: "app/assets/styles",
  },
  scripts: {
    src: ["src/assets/scripts/js/*.js", "!src/assets/scripts/vendor/*.js"],
...
export function serve() {
  ...
  watch("src/assets/scripts/vendor/*.js", series(scripts)).on(
    "change",
    bs.reload
  );
  watch(paths.scripts.src, series(lint, handleMainJsFile)).on(
    "change",
    bs.reload
  );
